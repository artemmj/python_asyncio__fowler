...
class FileUpload:
    ...
    def listen_for_uploads(self):
        """
        Создать задачу, которая читает загружаемые
        данные и добавляет их в конец буфера.
        """
    ...
    async def get_contents(self):
        """
        Блокирует выполнение, пока событие _finished_event не будет
        установлено, а потом возвращает содержимое буфера.
        """
